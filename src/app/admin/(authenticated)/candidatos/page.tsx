...
import { Eye, FileText, MoreHorizontal, Download, Loader2, Search, Filter, X, Archive, Trash2 } from "lucide-react"
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {loading ? (
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={6} className="h-40 text-center text-gray-400 font-medium font-heading">
                                                ...
                                                <div className="flex justify-end gap-2">
                                                    <AlertDialog>
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>Arquivar Candidato</TooltipContent>
                                                        </Tooltip>
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader>
                                                                <AlertDialogTitle>Arquivar Candidato?</AlertDialogTitle>
                                                                <AlertDialogDescription>
                                                                    O candidato <strong>{candidate.name}</strong> será movido para o arquivo e não aparecerá mais nesta lista.
                                                                </AlertDialogDescription>
                                                            </AlertDialogHeader>
                                                            <AlertDialogFooter>
                                                                <AlertDialogCancel>Voltar</AlertDialogCancel>
                                                                <AlertDialogAction
                                                                    onClick={() => archiveCandidate(candidate.id)}
